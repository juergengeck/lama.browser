...
export function AISettingsView() {
  ...
  const ensureClaudeContacts = async () => {
    ...
    console.warn('[AISettingsView] ensureClaudeContacts not available in browser')
  }
  ...
  const handleSaveClaudeApiKey = async () => {
    ...
    try {
      // Not available in browser - API key storage requires backend
      throw new Error('API key storage not available in browser')
    } catch (error) {
