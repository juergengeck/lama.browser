    ...
    <View style={{ flex: 1, backgroundColor: theme.colors.background }}>
      ...
      >
        ...
        <Tabs.Screen
          name="messages"
          options={{
            tabBarLabel: t('tabs.messages', { defaultValue: 'Messages' }),
            tabBarIcon: ({ color, size }) => (
        ...
        <Tabs.Screen
          name="journal"
          options={{
            title: t('journal.title', { defaultValue: 'Journal' }),
            tabBarLabel: t('tabs.journal', { defaultValue: 'Journal' }),
            tabBarIcon: ({ color, size }) => (
        ...
        <Tabs.Screen
          name="contacts"
          options={{
            title: t('devices.title', { defaultValue: 'Devices' }),
            tabBarLabel: t('tabs.devices', { defaultValue: 'Devices' }),
            tabBarIcon: ({ color, size }) => (
        ...
        <Tabs.Screen
          ...
          options={{
            ...
            tabBarIcon: ({ color, size }) => (
              <MaterialCommunityIcons name="cog" size={size} color={theme.colors.primary} />
            ),
          }}
        />
      </Tabs>
