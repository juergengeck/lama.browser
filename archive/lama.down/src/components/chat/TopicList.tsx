...
export function TopicList({ topicModel, channelManager, onTopicSelect }: TopicListProps) {
  ...
  return (
    <View style={styles.container}>
      <Searchbar
        placeholder={t('topicList.searchPlaceholder', { defaultValue: 'Search conversations' })}
    ...
    <List.Item
      ...
      description={
        item.isAITopic && isTopicLoading(item.id)
          ? t('topicList.preparingModel', { defaultValue: 'Preparing model...' })
          : item.lastMessage || t('topicList.noMessages', { defaultValue: 'No messages yet' })
      }
        ...
        <View style={styles.rightContent}>
          ...
          <Text style={styles.participantCount}>
            {item.participantCount} {item.participantCount === 1
              ? t('topicList.participant', { defaultValue: 'participant' })
              : t('topicList.participants', { defaultValue: 'participants' })
            }
          </Text>
        </View>
      )}
